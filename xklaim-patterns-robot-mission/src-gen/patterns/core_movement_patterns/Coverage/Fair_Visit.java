...
public class Fair_Visit extends KlavaProcess {
  private String robotId;
  
  private List<Location> locations;
  
  public Fair_Visit(final String robotId, final List<Location> locations) {
  ...
  public void executeProcess() {
    ...
    final int[] trace = TraceGenerator.createFair(n);
    ...
    out(new Tuple(new Object[] {RobotConstants.FAIR_VISIT_COMPLETED}), this.self);
