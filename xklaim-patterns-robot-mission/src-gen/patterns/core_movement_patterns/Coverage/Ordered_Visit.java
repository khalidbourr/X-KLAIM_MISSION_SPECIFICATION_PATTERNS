...
public class Ordered_Visit extends KlavaProcess {
  private String robotId;
  
  private List<Location> locations;
  
  public Ordered_Visit(final String robotId, final List<Location> locations) {
  ...
  public void executeProcess() {
    ...
    final int[] trace = TraceGenerator.createOrdered(n);
    ...
    out(new Tuple(new Object[] {RobotConstants.ORDERED_VISIT_COMPLETED}), this.self);
