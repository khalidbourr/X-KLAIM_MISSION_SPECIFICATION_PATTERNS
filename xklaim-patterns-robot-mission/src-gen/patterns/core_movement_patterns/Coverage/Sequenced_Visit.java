...
/**
 * Visits a set of locations in sequence, one after the other.
 * 
 * @param robotId   the ID of the robot
 * @param locations the list of locations to visit
 */
@SuppressWarnings("all")
public class Sequenced_Visit extends KlavaProcess {
  private String robotId;
  
  private List<Location> locations;
  
  public Sequenced_Visit(final String robotId, final List<Location> locations) {
  ...
  public void executeProcess() {
    ...
    final int[] trace = TraceGenerator.createSequenced(n);
    ...
    out(new Tuple(new Object[] {RobotConstants.SEQUENCED_VISIT_COMPLETED}), this.self);
